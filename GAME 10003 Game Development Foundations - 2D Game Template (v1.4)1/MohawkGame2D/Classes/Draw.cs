...
namespace MohawkGame2D
{
    ...
    public static class Draw
    {
        ...
        public static void Line(float x1, float y1, float x2, float y2, string v)
        ...
        public static void Line(int v, int v1, int v2, Vector2 start, Vector2 end)
        ...
        internal static void Line(int v1, int v2, int v3, int v4, Color blue)
        {
            throw new NotImplementedException();
        }
